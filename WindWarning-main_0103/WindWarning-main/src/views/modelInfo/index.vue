...
const algorithmStandRelateList = ref([])
...
const getModelData = async () => {
  try {
    ...
    algorithmStandRelateList.value = data.algorithmStandRelateList
...
provide('standPointList', standPointList)
provide('algorithmStandRelateList', algorithmStandRelateList)
